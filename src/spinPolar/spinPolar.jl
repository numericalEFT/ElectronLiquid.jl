...
function MC_Clib(para; kgrid=[para.kF,], ngrid=[0], neval=1e6, reweight_goal=nothing,
    ...
    root_dir=joinpath(@__DIR__, "source_codeGV/"), Generator=:GV
)
    # if Generator==:GV
    ...
    diaginfo = SpinPolar.diagram_loadinfo(para, _partition, root_dir=root_dir)
    polar, result = SpinPolar.KW_Clib(para, diaginfo;
...
function MC(para; kgrid=[para.kF,], ngrid=[0], neval=1e6, reweight_goal=nothing,
    ...
    diagram = Diagram.diagram_parquet_noresponse(:spinPolar, para, partition, filter=filter, extK=extK, optimize_level=optimize_level)
    ...
    polar, result = SpinPolar.KW(para, diagram;
...
function diagram_loadinfo(paramc::ParaMC, _partition::Vector{T};
    ...
    root_dir=joinpath(@__DIR__, "source_codeGV/"), filename="extvars_spinPolar.jld2"
) where {T}
...
include("source_codeGV/Cwrapper_spinPolar_GV.jl")

const evalfuncGV_spinPolar_map = Dict(
    (1, 0, 0) => eval_spinPolar_GV100!,
    (1, 1, 0) => eval_spinPolar_GV110!,
    (1, 2, 0) => eval_spinPolar_GV120!,
    (1, 3, 0) => eval_spinPolar_GV130!,
    (1, 4, 0) => eval_spinPolar_GV140!,
    # (1, 5, 0) => eval_spinPolar_GV150!,
    (2, 0, 0) => eval_spinPolar_GV200!,
    (2, 0, 1) => eval_spinPolar_GV201!,
    (2, 0, 2) => eval_spinPolar_GV202!,
    (2, 0, 3) => eval_spinPolar_GV203!,
    # (2, 0, 4) => eval_spinPolar_GV204!,
    (2, 1, 0) => eval_spinPolar_GV210!,
    (2, 1, 1) => eval_spinPolar_GV211!,
    (2, 1, 2) => eval_spinPolar_GV212!,
    # (2, 1, 3) => eval_spinPolar_GV213!,
    (2, 2, 0) => eval_spinPolar_GV220!,
    (2, 2, 1) => eval_spinPolar_GV221!,
    # (2, 2, 2) => eval_spinPolar_GV222!,
    (2, 3, 0) => eval_spinPolar_GV230!,
    # (2, 3, 1) => eval_spinPolar_GV231!,
    # (2, 4, 0) => eval_spinPolar_GV240!,
    (3, 0, 0) => eval_spinPolar_GV300!,
    (3, 0, 1) => eval_spinPolar_GV301!,
    (3, 0, 2) => eval_spinPolar_GV302!,
    # (3, 0, 3) => eval_spinPolar_GV303!,
    (3, 1, 0) => eval_spinPolar_GV310!,
    (3, 1, 1) => eval_spinPolar_GV311!,
    # (3, 1, 2) => eval_spinPolar_GV312!,
    (3, 2, 0) => eval_spinPolar_GV320!,
    # (3, 2, 1) => eval_spinPolar_GV321!,
    # (3, 3, 0) => eval_spinPolar_GV330!,
    (4, 0, 0) => eval_spinPolar_GV400!,
    (4, 0, 1) => eval_spinPolar_GV401!,
    # (4, 0, 2) => eval_spinPolar_GV402!,
    (4, 1, 0) => eval_spinPolar_GV410!,
    # (4, 1, 1) => eval_spinPolar_GV411!,
    # (4, 2, 0) => eval_spinPolar_GV420!,
    (5, 0, 0) => eval_spinPolar_GV500!,
    # (5, 0, 1) => eval_spinPolar_GV501!,
    # (5, 1, 0) => eval_spinPolar_GV510!,
    # (6, 0, 0) => eval_spinPolar_GV600!
)
