...
\begin{equation}
    \label{eq:condition4}
    f^+ = \overline{\Gamma^{4,R}_{k_1, k_2; k_1-q, k_2+q}}-v_q.
\end{equation}
where the symbol $\overline{\Gamma_4}$ means three operations:
...
\begin{figure}
    ...
    \label{fig:sigma1}
    \caption{One-loop renormalized Feynman diagram of the quasiparticle self-energy.}
\end{figure}
